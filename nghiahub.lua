...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		txdlid.BackgroundColor3 = Color3.fromRGB(130, 130, 130)
		...
		Time.Active = true
		Time.BackgroundColor3 = Color3.fromRGB(130, 130, 130)
		...
		TweenService:Create(
			...
			{Size = UDim2.new(0, 0, 0, 3)} -- UDim2.new(130, 130, 130))
		):Play()
		delay(tonumber(delays),function()
			TweenService:Create(
				imagenoti,
				TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
				{ImageTransparency = 1} -- UDim2.new(130, 130, 130))
			):Play()
			TweenService:Create(
				TextNoti,
				TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
				{TextTransparency = 1} -- UDim2.new(130, 130, 130))
			):Play()
			TweenService:Create(
				txdlid,
				TweenInfo.new(0.2, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut),
			...
			TweenService:Create(
				...
				{Size = UDim2.new(0, 0, 0, 70)} -- UDim2.new(130, 130, 130))
			):Play()
			wait(0.3)
			TitleFrame:Destroy()
		end
	...
	DiscordLib:Notification("Thông Báo" , "Chào Bạn Nghĩa Cu To" , 6 ,16761490896 )
	DiscordLib:Notification("Thông Báo" , "Nghĩa Ngu Như Chó" , 6 ,16761490896 )
...
ImageButton.Image = "rbxassetid://16787697780"
